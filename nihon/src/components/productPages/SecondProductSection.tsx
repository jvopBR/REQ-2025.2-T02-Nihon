...
export default function SecondProductSection({ products }: { products?: any[] }) {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {display.map((item: any) => {
        ...
        return (
          ...
          >
            <div className="p-3 flex flex-col items-stretch h-full">
              {/* container com aspect ratio e Image fill para evitar cortes */}
              <div className="relative w-full rounded mb-2 overflow-hidden bg-gray-50" style={{ paddingBottom: "56.25%" }}>
                <Image
                  src={finalSrc}
              ...
              <div className="text-center text-sm font-semibold text-gray-800 line-clamp-2">
                {item.nome}
              </div>
            </div>
          </Link>
